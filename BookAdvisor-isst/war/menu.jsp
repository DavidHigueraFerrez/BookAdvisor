...
<title>Menú principal - Bookadvisor</title>
			...
			<!-- Banner -->
				<section id="banner">
					<div class="content menu-ancho">
						<a href="/mybooks"><div class="col-sm-3 button special categorias">
						Mis Libros Subidos
						</div></a>
						<a href="/books"><div class="col-sm-3 button special categorias">
						Biblioteca
						</div></a>
